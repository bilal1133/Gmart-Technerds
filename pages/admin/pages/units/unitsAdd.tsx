...
export default class UnitsAdd extends Component<AppProps & RouteProps, AppState> {
    ...
    async componentDidMount() {
        ...
        if (this.props.match && this.props.match.params.id > 0)
            this.getUnitInfoById(this.props.match.params.id);

        this.getLangs();
    }

    async getUnitInfoById(id: number) {
        //get brand by id
        const {data: data} = await axios.post('/api/units/info', {id});
    ...
    async saveUnits() {
        if (this.state.names.length > 0) {
            ...
            //save brands data
            const {data: data} = await axios.post('/api/units/save', formData, config);
            ...
            if (this.state.names.length != this.state.langs.length)
                error += "Unit name is not entered in some languages.\n"
    ...
    render() {
        ...
        return (
            <Layout>
                <Head>
                    <title>Gmarket - Add Unit</title>
                    <meta name="viewport" content="initial-scale=1.0, width=device-width"/>
                </Head>
                <h1 className="h3 mb-2 text-gray-800">Add unit</h1>
                    ...
                    <div className="card-body">
                        ...
                        <form>
                            ...
                            <div className="form-group row">
                                <div className="col col-md-6 col-sm-12">
                                    ...
                                    <input className="form-control" onChange={this.onChangeName} value={this.state.name}
                                           placeholder="Unit name" required={true}/>
                                </div>
                                <div className="col col-md-6 col-sm-12">
                            ...
                            <div className="col col-md-12 col-sm-12">
                                <input onClick={this.saveUnits} value="Save Units"
